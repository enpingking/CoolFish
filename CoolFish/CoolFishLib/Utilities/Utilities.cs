...
namespace CoolFishNS.Utilities
{
    ...
    internal static class Utilities
    {
        ...
        internal static void Upsert<TKey, TValue>(this IDictionary<TKey, TValue> dictionary,
            IDictionary<TKey, TValue> dictionaryToUpsert)
        {
        ...
        internal static void Reconfigure(LogLevel level)
        {
        ...
        internal static void Reconfigure(int ordinal)
        {
        ...
        internal static void InitializeLoggers()
        {
            lock (LoggerLock)
            {
                ...
                var activeLogFileName = string.Format("{0}\\Logs\\{1}\\[CoolFish-{2}] {3}.txt",
                    Constants.ApplicationPath.Value,
